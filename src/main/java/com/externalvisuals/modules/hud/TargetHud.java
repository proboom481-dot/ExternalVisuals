...
public final class TargetHud extends HudModule {
    ...
    private final BooleanSetting armorBars = addSetting(new BooleanSetting("Armor Bars", true));
    private final BooleanSetting pulseAccent = addSetting(new BooleanSetting("Pulse Accent", true));
    ...
    public boolean isArmorBarsEnabled() { return armorBars.isEnabled(); }
    public boolean isPulseAccentEnabled() { return pulseAccent.isEnabled(); }

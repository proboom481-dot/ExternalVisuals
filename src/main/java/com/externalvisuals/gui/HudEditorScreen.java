...
public final class HudEditorScreen extends Screen {
    ...
    public void render(
        ...
        textRenderer.draw(
                matrices, helpText,
                (width - textRenderer.getWidth(helpText)) / 2.0f,
                34.0f, AMOLEDTheme.TEXT_MUTED
        );
        ...
        textRenderer.draw(
                matrices, backText,
                (width - textRenderer.getWidth(backText)) / 2.0f,
                height - 18.0f, AMOLEDTheme.TEXT_MUTED
        );
        ...
        if (hovered) {
            String positionText =
                    Math.round(hud.getX())
                            ...
                            + Math.round(hud.getY())
                            + "  "
                            + Math.round(hud.getScale() * 100.0f)
                            + "%";
            textRenderer.draw(
                    matrices, positionText,
                    x + 8.0f, y + drawHeight + 3.0f,

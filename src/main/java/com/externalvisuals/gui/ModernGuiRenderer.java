...
public final class ModernGuiRenderer {
    ...
    private void drawModuleCard(
        ...
        /*
         * Settings plus button.
         * Left click on + opens the selected module settings.
         */
        int plusSize = 20;
    ...
    public boolean mouseClicked(
        ...
        for (Module module :
            ...
            int plusX =
                    cardX + cardWidth - plusSize - 12;

            int plusY =
                    cardY + (cardHeight - plusSize) / 2;

            boolean plusHovered =
                    mouseX >= plusX
                            && mouseX <= plusX + plusSize
                            && mouseY >= plusY
                            && mouseY <= plusY + plusSize;

            /*
             * Left click on + opens settings.
             */
            if (button == 0 && plusHovered) {
    ...
    public static boolean isSecretModule(Module module) {
        ...
        return "ESP".equalsIgnoreCase(name)
                || "Hitbox".equalsIgnoreCase(name)
                || "Aim Assist".equalsIgnoreCase(name)
                || "Damage Numbers".equalsIgnoreCase(name)
                || "Hitmarker".equalsIgnoreCase(name)
                || "Hit Particles".equalsIgnoreCase(name)
                || "Hit Effects".equalsIgnoreCase(name)
                || "TNT Timer".equalsIgnoreCase(name)
                || "No Hurt Cam".equalsIgnoreCase(name)
                || "Auto Sprint".equalsIgnoreCase(name)
                || "Zoom".equalsIgnoreCase(name);
    }

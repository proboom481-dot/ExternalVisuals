...
import com.externalvisuals.render.CosmeticsRenderer;
import com.externalvisuals.render.PulseVisualsRenderer;
import com.externalvisuals.modules.audio.Music;
import com.externalvisuals.render.TrajectoryRenderer;
...
public class ExternalVisuals
    ...
    public void onInitializeClient() {
        ...
        TargetRing.init();
        BlockOutline.init();
        CosmeticsRenderer.init();
        PulseVisualsRenderer.init();
        Music.initRegistry();
                ...
                client -> {
                    ...
                    if (MODULE_MANAGER != null) {
                        if (client.world != null) {
                            ConfigManager.applyPendingEnabledState();
                        }
